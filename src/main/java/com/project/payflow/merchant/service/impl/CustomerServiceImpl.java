...
import com.project.payflow.merchant.entity.Customer;
import com.project.payflow.merchant.entity.Merchant;
import com.project.payflow.merchant.repository.CustomerRepository;
...
public class CustomerServiceImpl implements CustomerService {
    ...
    private UUID createNew(UUID merchantId, String email, String name, String phone) {
        ...
        log.info("Customer created via findOrCreate id={} merchant={} email={}",
